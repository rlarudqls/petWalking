...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull LinearLayout rootView, @NonNull TextView WeatherText,
      @NonNull ImageView imageViewWeather, @NonNull TextView textViewHumidity,
      @NonNull TextView textViewWind, @NonNull TextView textviewMaxtemp,
      @NonNull TextView textviewNowCloud) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageView_Weather;
      ImageView imageViewWeather = ViewBindings.findChildViewById(rootView, id);
      if (imageViewWeather == null) {
        break missingId;
      }
      ...
      return new FragmentHomeBinding((LinearLayout) rootView, WeatherText, imageViewWeather,
          textViewHumidity, textViewWind, textviewMaxtemp, textviewNowCloud);
    }
