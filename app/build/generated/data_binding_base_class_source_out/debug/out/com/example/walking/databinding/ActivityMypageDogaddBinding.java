...
public final class ActivityMypageDogaddBinding implements ViewBinding {
  ...
  private ActivityMypageDogaddBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull EditText mypageDogAddDogBirthYear, @NonNull EditText mypageDogAddDogWeight,
      @NonNull EditText mypageDogAddName, @NonNull AppCompatButton mypageDogAddSub,
      @NonNull AutoCompleteTextView mypageDogSpecies) {
  ...
  public static ActivityMypageDogaddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMypageDogaddBinding((FrameLayout) rootView, mypageDogAddDogBirthDay,
          mypageDogAddDogBirthMonth, mypageDogAddDogBirthYear, mypageDogAddDogWeight,
          mypageDogAddName, mypageDogAddSub, mypageDogSpecies);
    }
